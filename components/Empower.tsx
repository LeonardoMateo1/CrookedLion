...
const Empower = () => {
    return (
        <div className="w-full new">
            ...
            <div className="h-full w-full max-width flex-between flex-row-reverse text-end">
                <div className="font-medium w-[644px]">
                    <p className="font-semibold ">Empower</p>
                    <h2 className="home_h w-[634px]">Make Informed Investment Decisions with Ease</h2>
                    ...
                    <div className="mt-7 flex gap-5 items-center justify-end text-xl">
                        <Link href='/SignUp'>
                            <CustomButton 
                            title="Learn More"
                ...
                <div className="flex-1 w-full h-full flex justify-start items-start">
                    <div className="relative w-[486px] h-[600px] ">
                        <Image fill src='/Empower_image.jpg' alt="empower" sizes="486px" priority className="object-cover rounded-r-2xl"/>
                    </div>
                </div>
            </div>

    ...
    return (
        <div className="w-full new flex">
            <div className="h-full w-full max-width items-center flex flex-col">
                <h2 className="home_h mb-20">Testimonials</h2>
                <p className="font-semibold text-2xl text-center w-[750px] mb-10">
            ...
            <div className="h-[63px] w-[48%] bg-colm"/>
            <div className="h-[63px] w-[43%] bg-colm2"/>
            <div className="h-[63px] w-[38%] bg-colm3"/>
            <div className="h-[63px] w-[33%] bg-colm4"/>
            <div className="h-[63px] w-[28%] bg-colm5"/>
            <div className="h-[63px] w-[23%] bg-colm6"/>
            </div>
